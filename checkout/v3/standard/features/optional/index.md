...
- title: Custom Logo
  ...
  url: /checkout/v3/standard/features/optional/custom-logo
  icon:
    content: copyright
    outlined: true
...
- title: Recur
  ...
  url:  /checkout/v3/standard/features/optional/recur
  icon:
    content: cached
    outlined: true
- title: Verify
  description: Validating the payer's payment details
  url:  /checkout/v3/standard/features/optional/verify
  icon:
