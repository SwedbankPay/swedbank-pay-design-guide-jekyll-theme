...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ...
    source_dir = File.expand_path(File.join(__dir__, '..'))
    dest_dir = File.expand_path(File.join(source_dir, '_site'))
    config = Jekyll.configuration(
      {
        'config' => File.expand_path(File.join(source_dir, '_config.yml')),
        'incremental' => true,
        'source' => source_dir,
